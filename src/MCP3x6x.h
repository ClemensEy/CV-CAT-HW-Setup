...
// ADC Commands and Registers original
const unsigned char initialConfigData[7] = 
{
 ...
 0b00100000, // Config0: No total shutdown, external clock (up to 20MHz clock input), 0uA on ADC inputs, ADC standby mode
 ...
 0b00110000, // Config3: One-shot conversion then standby mode, 16-bit two's complement ADC data (SGN + 15 bit), CRC disabled, offset and gain disabled
 0b00000110, // IRQ Register: Fast commands enabled, IRQ active low enabled (connected to dataReadyPin)
 0b00001000 // Mux register: Channel 0 on +, REFIN- on -};
};
// ADC Commands and Registers
const unsigned char initialConfigData_original[7] = 
{
 0b01000110, // Control byte: Device address 1, incremental write starting at address 1 (Config0 register)
 0b11100010, // Config0: No total shutdown, external clock (up to 20MHz clock input), 0uA on ADC inputs, ADC standby mode
 0b00000000, // Config1: No clock prescaler, 32 oversampling ratio, 00 (reserved bits)
 0b10001111, // Config2: 1x Boost, 16x Gain, auto-zeroing enabled, reserved bits set to 1
